...
public class FulfillmentContext {
  ...
  /**
   * @param fulfillmentCenter1OutboundFolder the fulfillmentCenter1OutboundFolder to set
   */
  ...
  /**
   * @param fulfillmentCenter1FileName the fulfillmentCenter1FileName to set
   */
